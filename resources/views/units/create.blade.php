                ...
                <div class="card-body">
                            <form method="POST" action="{{ route('units.store') }}" >
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="block_no" type="number" class="form-control @error('block_no') is-invalid @enderror" name="block_no" value="{{ old('block_no') }}"  required autocomplete="block_no" autofocus>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <input id="occupant_name" type="text" class="form-control @error('occupant_name') is-invalid @enderror" name="occupant_name" value="{{ old('occupant_name') }}"  required autocomplete="occupant_name">
