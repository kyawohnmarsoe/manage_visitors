...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Visitors List <a href="/visitors/create"><button class="btn btn-primary float-right ">Add New Visitor</button></a></div>
                @if (session('msg'))
                ...
                <div class="card-body">
                 ...
                 <table class="table">
                        ...
                        <tbody>
                            ...
                            <td><a href="/visitors/detail/{{$visitor->visitor_name}}&{{$visitor->nric_no}}">{{$visitor->visitor_name}}</a></td>
